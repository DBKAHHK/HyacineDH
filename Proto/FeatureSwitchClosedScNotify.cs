...
namespace EggLink.DanhengServer.Proto {
    ...
    static FeatureSwitchClosedScNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "eRInCgtFSk1ITEZMRkRJUBgOIAEoDjISLkZlYXR1cmVTd2l0Y2hUeXBlQh6q",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.FeatureSwitchClosedScNotify), global::EggLink.DanhengServer.Proto.FeatureSwitchClosedScNotify.Parser, new[]{ "EJMHLFLFDIP" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public FeatureSwitchClosedScNotify(FeatureSwitchClosedScNotify other) : this() {
      eJMHLFLFDIP_ = other.eJMHLFLFDIP_;
    ...
    /// <summary>Field number for the "EJMHLFLFDIP" field.</summary>
    public const int EJMHLFLFDIPFieldNumber = 14;
    private global::EggLink.DanhengServer.Proto.FeatureSwitchType eJMHLFLFDIP_ = global::EggLink.DanhengServer.Proto.FeatureSwitchType.FeatureSwitchNone;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::EggLink.DanhengServer.Proto.FeatureSwitchType EJMHLFLFDIP {
      get { return eJMHLFLFDIP_; }
      set {
        eJMHLFLFDIP_ = value;
      }
    }
    ...
    public bool Equals(FeatureSwitchClosedScNotify other) {
      ...
      if (EJMHLFLFDIP != other.EJMHLFLFDIP) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (EJMHLFLFDIP != global::EggLink.DanhengServer.Proto.FeatureSwitchType.FeatureSwitchNone) hash ^= EJMHLFLFDIP.GetHashCode();
    ...
    #else
      if (EJMHLFLFDIP != global::EggLink.DanhengServer.Proto.FeatureSwitchType.FeatureSwitchNone) {
        output.WriteRawTag(112);
        output.WriteEnum((int) EJMHLFLFDIP);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      int size = 0;
      if (EJMHLFLFDIP != global::EggLink.DanhengServer.Proto.FeatureSwitchType.FeatureSwitchNone) {
        size += 1 + pb::CodedOutputStream.ComputeEnumSize((int) EJMHLFLFDIP);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(FeatureSwitchClosedScNotify other) {
      ...
      if (other.EJMHLFLFDIP != global::EggLink.DanhengServer.Proto.FeatureSwitchType.FeatureSwitchNone) {
        EJMHLFLFDIP = other.EJMHLFLFDIP;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          default:
            ...
            break;
          case 112: {
            EJMHLFLFDIP = (global::EggLink.DanhengServer.Proto.FeatureSwitchType) input.ReadEnum();
            break;
          }
        }
      }
