...
namespace EggLink.DanhengServer.Proto {
    ...
    static SceneEnterStageCsReqReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "b3RvImMKFFNjZW5lRW50ZXJTdGFnZUNzUmVxEhAKCGV2ZW50X2lkGAggASgN",
            "EhMKC1BLSEVDT0dLQUNIGAsgASgIEiQKDXJlYmF0dGxlX3R5cGUYDCABKA4y",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.SceneEnterStageCsReq), global::EggLink.DanhengServer.Proto.SceneEnterStageCsReq.Parser, new[]{ "EventId", "PKHECOGKACH", "RebattleType" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public SceneEnterStageCsReq(SceneEnterStageCsReq other) : this() {
      ...
      pKHECOGKACH_ = other.pKHECOGKACH_;
    ...
    /// <summary>Field number for the "PKHECOGKACH" field.</summary>
    public const int PKHECOGKACHFieldNumber = 11;
    private bool pKHECOGKACH_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool PKHECOGKACH {
      get { return pKHECOGKACH_; }
      set {
        pKHECOGKACH_ = value;
      }
    }
    ...
    public const int RebattleTypeFieldNumber = 12;
    ...
    public bool Equals(SceneEnterStageCsReq other) {
      ...
      if (PKHECOGKACH != other.PKHECOGKACH) return false;
    ...
    public override int GetHashCode() {
      ...
      if (PKHECOGKACH != false) hash ^= PKHECOGKACH.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (PKHECOGKACH != false) {
        output.WriteRawTag(88);
        output.WriteBool(PKHECOGKACH);
      }
    ...
    public void MergeFrom(SceneEnterStageCsReq other) {
      ...
      if (other.PKHECOGKACH != false) {
        PKHECOGKACH = other.PKHECOGKACH;
      }
