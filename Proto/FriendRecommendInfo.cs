...
namespace EggLink.DanhengServer.Proto {
    ...
    static FriendRecommendInfoReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "LnByb3RvIlIKE0ZyaWVuZFJlY29tbWVuZEluZm8SEwoLSUlLSEdNR0dBR0IY",
            "CCABKAgSJgoLcGxheWVyX2luZm8YDSABKAsyES5QbGF5ZXJTaW1wbGVJbmZv",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.FriendRecommendInfo), global::EggLink.DanhengServer.Proto.FriendRecommendInfo.Parser, new[]{ "IIKHGMGGAGB", "PlayerInfo" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public FriendRecommendInfo(FriendRecommendInfo other) : this() {
      iIKHGMGGAGB_ = other.iIKHGMGGAGB_;
    ...
    /// <summary>Field number for the "IIKHGMGGAGB" field.</summary>
    public const int IIKHGMGGAGBFieldNumber = 8;
    private bool iIKHGMGGAGB_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool IIKHGMGGAGB {
      get { return iIKHGMGGAGB_; }
      set {
        iIKHGMGGAGB_ = value;
      }
    }
    ...
    public bool Equals(FriendRecommendInfo other) {
      ...
      if (IIKHGMGGAGB != other.IIKHGMGGAGB) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (IIKHGMGGAGB != false) hash ^= IIKHGMGGAGB.GetHashCode();
    ...
    #else
      if (IIKHGMGGAGB != false) {
        output.WriteRawTag(64);
        output.WriteBool(IIKHGMGGAGB);
      }
      if (playerInfo_ != null) {
    ...
    public void MergeFrom(FriendRecommendInfo other) {
      ...
      if (other.IIKHGMGGAGB != false) {
        IIKHGMGGAGB = other.IIKHGMGGAGB;
      }
