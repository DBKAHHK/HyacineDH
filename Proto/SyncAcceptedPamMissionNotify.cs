...
namespace EggLink.DanhengServer.Proto {
    ...
    static SyncAcceptedPamMissionNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "Y2NlcHRlZFBhbU1pc3Npb25Ob3RpZnkSEwoLTUxCS0pCSUlGTk4YASABKAQS",
            "FwoPbWFpbl9taXNzaW9uX2lkGAMgASgNQh6qAhtFZ2dMaW5rLkRhbmhlbmdT",
            "ZXJ2ZXIuUHJvdG9iBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.SyncAcceptedPamMissionNotify), global::EggLink.DanhengServer.Proto.SyncAcceptedPamMissionNotify.Parser, new[]{ "MLBKJBIIFNN", "MainMissionId" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public SyncAcceptedPamMissionNotify(SyncAcceptedPamMissionNotify other) : this() {
      mLBKJBIIFNN_ = other.mLBKJBIIFNN_;
    ...
    /// <summary>Field number for the "MLBKJBIIFNN" field.</summary>
    public const int MLBKJBIIFNNFieldNumber = 1;
    private ulong mLBKJBIIFNN_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public ulong MLBKJBIIFNN {
      get { return mLBKJBIIFNN_; }
      set {
        mLBKJBIIFNN_ = value;
      }
    }
    ...
    public bool Equals(SyncAcceptedPamMissionNotify other) {
      ...
      if (MLBKJBIIFNN != other.MLBKJBIIFNN) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (MLBKJBIIFNN != 0UL) hash ^= MLBKJBIIFNN.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (MLBKJBIIFNN != 0UL) {
        ...
        output.WriteUInt64(MLBKJBIIFNN);
      }
      if (MainMissionId != 0) {
    ...
    public int CalculateSize() {
      int size = 0;
      if (MLBKJBIIFNN != 0UL) {
        size += 1 + pb::CodedOutputStream.ComputeUInt64Size(MLBKJBIIFNN);
      }
      if (MainMissionId != 0) {
    ...
    public void MergeFrom(SyncAcceptedPamMissionNotify other) {
      ...
      if (other.MLBKJBIIFNN != 0UL) {
        MLBKJBIIFNN = other.MLBKJBIIFNN;
      }
