...
namespace EggLink.DanhengServer.Proto {
    ...
    static ReplayInfoReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "YXlJbmZvEhMKC0dMQk5LR05CT09HGAEgASgEEiAKC3JlcGxheV90eXBlGAIg",
            "ASgOMgsuUmVwbGF5VHlwZRIQCghzdGFnZV9pZBgDIAEoDRILCgN1aWQYBCAB",
            "KA0SEAoIbmlja25hbWUYBSABKAkSEQoJaGVhZF9pY29uGAYgASgNEhMKC3Jl",
            "cGxheV9uYW1lGAcgASgJEhMKC2NyZWF0ZV90aW1lGAggASgEEhMKC0JDQ0xG",
            "QUVNSklKGAkgASgNEhMKC0lLRUJEQkNDSU1CGAogASgNQh6qAhtFZ2dMaW5r",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.ReplayInfo), global::EggLink.DanhengServer.Proto.ReplayInfo.Parser, new[]{ "GLBNKGNBOOG", "ReplayType", "StageId", "Uid", "Nickname", "HeadIcon", "ReplayName", "CreateTime", "BCCLFAEMJIJ", "IKEBDBCCIMB" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public ReplayInfo(ReplayInfo other) : this() {
      gLBNKGNBOOG_ = other.gLBNKGNBOOG_;
    ...
    /// <summary>Field number for the "GLBNKGNBOOG" field.</summary>
    public const int GLBNKGNBOOGFieldNumber = 1;
    private ulong gLBNKGNBOOG_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public ulong GLBNKGNBOOG {
      get { return gLBNKGNBOOG_; }
      set {
        gLBNKGNBOOG_ = value;
      }
    }
    ...
    public const int BCCLFAEMJIJFieldNumber = 9;
    ...
    public bool Equals(ReplayInfo other) {
      ...
      if (GLBNKGNBOOG != other.GLBNKGNBOOG) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (GLBNKGNBOOG != 0UL) hash ^= GLBNKGNBOOG.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (GLBNKGNBOOG != 0UL) {
        ...
        output.WriteUInt64(GLBNKGNBOOG);
      }
    ...
    public int CalculateSize() {
      int size = 0;
      if (GLBNKGNBOOG != 0UL) {
        size += 1 + pb::CodedOutputStream.ComputeUInt64Size(GLBNKGNBOOG);
      }
      if (ReplayType != global::EggLink.DanhengServer.Proto.ReplayType.None) {
    ...
    public void MergeFrom(ReplayInfo other) {
      ...
      if (other.GLBNKGNBOOG != 0UL) {
        GLBNKGNBOOG = other.GLBNKGNBOOG;
      }
