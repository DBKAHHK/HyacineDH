...
namespace EggLink.DanhengServer.Proto {
    ...
    static BattleAvatarReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "QXZhdGFyVHlwZS5wcm90bxoVQmF0dGxlRXF1aXBtZW50LnByb3RvGhFCYXR0",
            "bGVSZWxpYy5wcm90bxoRQ0JGTkFDTUtDUEkucHJvdG8aD1NwQmFySW5mby5w",
            ...
            "bGV2ZWwYDCABKA0SEgoKYXNzaXN0X3VpZBgNIAEoDRIhCgtGSUhGUEdPR0JK",
            "RRgPIAEoCzIMLkNCRk5BQ01LQ1BJEhoKBnNwX2JhchgQIAEoCzIKLlNwQmFy",
            "SW5mbxITCgtMSE5PSkFBT0pFRRgRIAEoDRIlCgtLSkVIRUNMR0JIQxgSIAMo",
            "CzIQLkF2YXRhclNraWxsVHJlZRITCgtlbmhhbmNlZF9pZBgTIAEoDUIeqgIb",
            "RWdnTGluay5EYW5oZW5nU2VydmVyLlByb3RvYgZwcm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::EggLink.DanhengServer.Proto.AvatarSkillTreeReflection.Descriptor, global::EggLink.DanhengServer.Proto.AvatarTypeReflection.Descriptor, global::EggLink.DanhengServer.Proto.BattleEquipmentReflection.Descriptor, global::EggLink.DanhengServer.Proto.BattleRelicReflection.Descriptor, global::EggLink.DanhengServer.Proto.CBFNACMKCPIReflection.Descriptor, global::EggLink.DanhengServer.Proto.SpBarInfoReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.BattleAvatar), global::EggLink.DanhengServer.Proto.BattleAvatar.Parser, new[]{ "AvatarType", "Id", "Level", "Rank", "Index", "SkilltreeList", "EquipmentList", "Hp", "Promotion", "RelicList", "WorldLevel", "AssistUid", "FIHFPGOGBJE", "SpBar", "LHNOJAAOJEE", "KJEHECLGBHC", "EnhancedId" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public BattleAvatar(BattleAvatar other) : this() {
      ...
      fIHFPGOGBJE_ = other.fIHFPGOGBJE_ != null ? other.fIHFPGOGBJE_.Clone() : null;
      spBar_ = other.spBar_ != null ? other.spBar_.Clone() : null;
      lHNOJAAOJEE_ = other.lHNOJAAOJEE_;
      kJEHECLGBHC_ = other.kJEHECLGBHC_.Clone();
    ...
    /// <summary>Field number for the "FIHFPGOGBJE" field.</summary>
    public const int FIHFPGOGBJEFieldNumber = 15;
    private global::EggLink.DanhengServer.Proto.CBFNACMKCPI fIHFPGOGBJE_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::EggLink.DanhengServer.Proto.CBFNACMKCPI FIHFPGOGBJE {
      get { return fIHFPGOGBJE_; }
      set {
        fIHFPGOGBJE_ = value;
      }
    }
    ...
    /// <summary>Field number for the "LHNOJAAOJEE" field.</summary>
    public const int LHNOJAAOJEEFieldNumber = 17;
    private uint lHNOJAAOJEE_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public uint LHNOJAAOJEE {
      get { return lHNOJAAOJEE_; }
      set {
        lHNOJAAOJEE_ = value;
      }
    }

    /// <summary>Field number for the "KJEHECLGBHC" field.</summary>
    public const int KJEHECLGBHCFieldNumber = 18;
    private static readonly pb::FieldCodec<global::EggLink.DanhengServer.Proto.AvatarSkillTree> _repeated_kJEHECLGBHC_codec
        = pb::FieldCodec.ForMessage(146, global::EggLink.DanhengServer.Proto.AvatarSkillTree.Parser);
    private readonly pbc::RepeatedField<global::EggLink.DanhengServer.Proto.AvatarSkillTree> kJEHECLGBHC_ = new pbc::RepeatedField<global::EggLink.DanhengServer.Proto.AvatarSkillTree>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<global::EggLink.DanhengServer.Proto.AvatarSkillTree> KJEHECLGBHC {
      get { return kJEHECLGBHC_; }
    }
    ...
    public bool Equals(BattleAvatar other) {
      ...
      if (!object.Equals(FIHFPGOGBJE, other.FIHFPGOGBJE)) return false;
      if (!object.Equals(SpBar, other.SpBar)) return false;
      if (LHNOJAAOJEE != other.LHNOJAAOJEE) return false;
      if(!kJEHECLGBHC_.Equals(other.kJEHECLGBHC_)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (fIHFPGOGBJE_ != null) hash ^= FIHFPGOGBJE.GetHashCode();
      if (spBar_ != null) hash ^= SpBar.GetHashCode();
      if (LHNOJAAOJEE != 0) hash ^= LHNOJAAOJEE.GetHashCode();
      hash ^= kJEHECLGBHC_.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (fIHFPGOGBJE_ != null) {
        output.WriteRawTag(122);
        output.WriteMessage(FIHFPGOGBJE);
      }
      if (spBar_ != null) {
      ...
      if (LHNOJAAOJEE != 0) {
        ...
        output.WriteUInt32(LHNOJAAOJEE);
      }
      kJEHECLGBHC_.WriteTo(output, _repeated_kJEHECLGBHC_codec);
      if (EnhancedId != 0) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      kJEHECLGBHC_.WriteTo(ref output, _repeated_kJEHECLGBHC_codec);
      if (EnhancedId != 0) {
        output.WriteRawTag(152, 1);
        output.WriteUInt32(EnhancedId);
      }
    ...
    public int CalculateSize() {
      ...
      if (fIHFPGOGBJE_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(FIHFPGOGBJE);
      }
      if (spBar_ != null) {
        size += 2 + pb::CodedOutputStream.ComputeMessageSize(SpBar);
      }
      if (LHNOJAAOJEE != 0) {
        size += 2 + pb::CodedOutputStream.ComputeUInt32Size(LHNOJAAOJEE);
      }
      size += kJEHECLGBHC_.CalculateSize(_repeated_kJEHECLGBHC_codec);
      if (EnhancedId != 0) {
    ...
    public void MergeFrom(BattleAvatar other) {
      ...
      if (other.fIHFPGOGBJE_ != null) {
        if (fIHFPGOGBJE_ == null) {
          FIHFPGOGBJE = new global::EggLink.DanhengServer.Proto.CBFNACMKCPI();
        }
        FIHFPGOGBJE.MergeFrom(other.FIHFPGOGBJE);
      }
      ...
      if (other.LHNOJAAOJEE != 0) {
        LHNOJAAOJEE = other.LHNOJAAOJEE;
      }
      kJEHECLGBHC_.Add(other.kJEHECLGBHC_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 136: {
            LHNOJAAOJEE = input.ReadUInt32();
            break;
          }
          case 146: {
            kJEHECLGBHC_.AddEntriesFrom(input, _repeated_kJEHECLGBHC_codec);
            break;
          }
          case 152: {
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          ...
          case 146: {
            kJEHECLGBHC_.AddEntriesFrom(ref input, _repeated_kJEHECLGBHC_codec);
            break;
          }
          case 152: {
            EnhancedId = input.ReadUInt32();
