...
namespace EggLink.DanhengServer.Proto {
  ...
  public static partial class QuestReflection {
    ...
    static QuestReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "CgtRdWVzdC5wcm90bxoRUXVlc3RTdGF0dXMucHJvdG8ibQoFUXVlc3QSCgoC",
            "aWQYASABKA0SEwoLZmluaXNoX3RpbWUYBSABKAMSEwoLT1BJTEtNUE1FQUUY",
            "BiADKA0SEAoIcHJvZ3Jlc3MYCiABKA0SHAoGc3RhdHVzGA0gASgOMgwuUXVl",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.Quest), global::EggLink.DanhengServer.Proto.Quest.Parser, new[]{ "Id", "FinishTime", "OPILKMPMEAE", "Progress", "Status" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public Quest(Quest other) : this() {
      ...
      oPILKMPMEAE_ = other.oPILKMPMEAE_.Clone();
    ...
    /// <summary>Field number for the "OPILKMPMEAE" field.</summary>
    public const int OPILKMPMEAEFieldNumber = 6;
    private static readonly pb::FieldCodec<uint> _repeated_oPILKMPMEAE_codec
        = pb::FieldCodec.ForUInt32(50);
    private readonly pbc::RepeatedField<uint> oPILKMPMEAE_ = new pbc::RepeatedField<uint>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<uint> OPILKMPMEAE {
      get { return oPILKMPMEAE_; }
    }
    ...
    public bool Equals(Quest other) {
      ...
      if(!oPILKMPMEAE_.Equals(other.oPILKMPMEAE_)) return false;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      oPILKMPMEAE_.WriteTo(output, _repeated_oPILKMPMEAE_codec);
      if (Progress != 0) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      oPILKMPMEAE_.WriteTo(ref output, _repeated_oPILKMPMEAE_codec);
      if (Progress != 0) {
        output.WriteRawTag(80);
        output.WriteUInt32(Progress);
      }
    ...
    public int CalculateSize() {
      ...
      size += oPILKMPMEAE_.CalculateSize(_repeated_oPILKMPMEAE_codec);
      if (Progress != 0) {
    ...
    public void MergeFrom(Quest other) {
      ...
      oPILKMPMEAE_.Add(other.oPILKMPMEAE_);
      if (other.Progress != 0) {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 50:
          case 48: {
            oPILKMPMEAE_.AddEntriesFrom(input, _repeated_oPILKMPMEAE_codec);
            break;
          }
          case 80: {
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          ...
          case 50:
          case 48: {
            oPILKMPMEAE_.AddEntriesFrom(ref input, _repeated_oPILKMPMEAE_codec);
            break;
          }
          case 80: {
            Progress = input.ReadUInt32();
