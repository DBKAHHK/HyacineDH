...
namespace EggLink.DanhengServer.Proto {
    ...
    static BattleOpReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ASgNEhMKC0JGTUFDSkhFS0tLGAggASgJQh6qAhtFZ2dMaW5rLkRhbmhlbmdT",
            "ZXJ2ZXIuUHJvdG9iBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.BattleOp), global::EggLink.DanhengServer.Proto.BattleOp.Parser, new[]{ "TurnCounter", "State", "ActionEntityId", "TargetEntityId", "OpType", "SkillIndex", "OperationCounter", "BFMACJHEKKK" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public BattleOp(BattleOp other) : this() {
      ...
      bFMACJHEKKK_ = other.bFMACJHEKKK_;
    ...
    /// <summary>Field number for the "BFMACJHEKKK" field.</summary>
    public const int BFMACJHEKKKFieldNumber = 8;
    private string bFMACJHEKKK_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public string BFMACJHEKKK {
      get { return bFMACJHEKKK_; }
      set {
        bFMACJHEKKK_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public bool Equals(BattleOp other) {
      ...
      if (BFMACJHEKKK != other.BFMACJHEKKK) return false;
    ...
    public override int GetHashCode() {
      ...
      if (BFMACJHEKKK.Length != 0) hash ^= BFMACJHEKKK.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (BFMACJHEKKK.Length != 0) {
        output.WriteRawTag(66);
        output.WriteString(BFMACJHEKKK);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (BFMACJHEKKK.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(BFMACJHEKKK);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(BattleOp other) {
      ...
      if (other.BFMACJHEKKK.Length != 0) {
        BFMACJHEKKK = other.BFMACJHEKKK;
      }
