...
namespace EggLink.DanhengServer.Proto {
    ...
    static StaminaInfoScNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "IAEoDRIXCg9yZXNlcnZlX3N0YW1pbmEYCiABKA0SEwoLS0VFTlBNT0JJQUgY",
            "DCABKANCHqoCG0VnZ0xpbmsuRGFuaGVuZ1NlcnZlci5Qcm90b2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.StaminaInfoScNotify), global::EggLink.DanhengServer.Proto.StaminaInfoScNotify.Parser, new[]{ "NextRecoverTime", "Stamina", "ReserveStamina", "KEENPMOBIAH" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public StaminaInfoScNotify(StaminaInfoScNotify other) : this() {
      ...
      kEENPMOBIAH_ = other.kEENPMOBIAH_;
    ...
    public const int ReserveStaminaFieldNumber = 10;
    ...
    /// <summary>Field number for the "KEENPMOBIAH" field.</summary>
    public const int KEENPMOBIAHFieldNumber = 12;
    private long kEENPMOBIAH_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public long KEENPMOBIAH {
      get { return kEENPMOBIAH_; }
      set {
        kEENPMOBIAH_ = value;
      }
    }
    ...
    public bool Equals(StaminaInfoScNotify other) {
      ...
      if (KEENPMOBIAH != other.KEENPMOBIAH) return false;
    ...
    public override int GetHashCode() {
      ...
      if (KEENPMOBIAH != 0L) hash ^= KEENPMOBIAH.GetHashCode();
    ...
    public int CalculateSize() {
      ...
      if (KEENPMOBIAH != 0L) {
        size += 1 + pb::CodedOutputStream.ComputeInt64Size(KEENPMOBIAH);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(StaminaInfoScNotify other) {
      ...
      if (other.KEENPMOBIAH != 0L) {
        KEENPMOBIAH = other.KEENPMOBIAH;
      }
