...
namespace EggLink.DanhengServer.Proto {
    ...
    static EntityMotionReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "aXR5TW90aW9uEhMKC0dETEZIRExIUERFGAEgASgIEhEKCWVudGl0eV9pZBgE",
            "IAEoDRIbCgZtb3Rpb24YCSABKAsyCy5Nb3Rpb25JbmZvEhEKCW1hcF9sYXll",
            "chgOIAEoDUIeqgIbRWdnTGluay5EYW5oZW5nU2VydmVyLlByb3RvYgZwcm90",
            "bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::EggLink.DanhengServer.Proto.MotionInfoReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.EntityMotion), global::EggLink.DanhengServer.Proto.EntityMotion.Parser, new[]{ "GDLFHDLHPDE", "EntityId", "Motion", "MapLayer" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public EntityMotion(EntityMotion other) : this() {
      gDLFHDLHPDE_ = other.gDLFHDLHPDE_;
    ...
    /// <summary>Field number for the "GDLFHDLHPDE" field.</summary>
    public const int GDLFHDLHPDEFieldNumber = 1;
    private bool gDLFHDLHPDE_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool GDLFHDLHPDE {
      get { return gDLFHDLHPDE_; }
      set {
        gDLFHDLHPDE_ = value;
      }
    }
    ...
    public bool Equals(EntityMotion other) {
      ...
      if (GDLFHDLHPDE != other.GDLFHDLHPDE) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (GDLFHDLHPDE != false) hash ^= GDLFHDLHPDE.GetHashCode();
    ...
    #else
      if (GDLFHDLHPDE != false) {
        output.WriteRawTag(8);
        output.WriteBool(GDLFHDLHPDE);
      }
      if (EntityId != 0) {
    ...
    public void MergeFrom(EntityMotion other) {
      ...
      if (other.GDLFHDLHPDE != false) {
        GDLFHDLHPDE = other.GDLFHDLHPDE;
      }
      if (other.EntityId != 0) {
