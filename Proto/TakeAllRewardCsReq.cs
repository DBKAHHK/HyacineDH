...
namespace EggLink.DanhengServer.Proto {
    ...
    static TakeAllRewardCsReqReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "b3RvIjoKElRha2VBbGxSZXdhcmRDc1JlcRIkCgtFRk1LSkFKT0tMSxgPIAMo",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.TakeAllRewardCsReq), global::EggLink.DanhengServer.Proto.TakeAllRewardCsReq.Parser, new[]{ "EFMKJAJOKLK" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public TakeAllRewardCsReq(TakeAllRewardCsReq other) : this() {
      eFMKJAJOKLK_ = other.eFMKJAJOKLK_.Clone();
    ...
    /// <summary>Field number for the "EFMKJAJOKLK" field.</summary>
    public const int EFMKJAJOKLKFieldNumber = 15;
    private static readonly pb::FieldCodec<global::EggLink.DanhengServer.Proto.OptionalReward> _repeated_eFMKJAJOKLK_codec
        = pb::FieldCodec.ForMessage(122, global::EggLink.DanhengServer.Proto.OptionalReward.Parser);
    private readonly pbc::RepeatedField<global::EggLink.DanhengServer.Proto.OptionalReward> eFMKJAJOKLK_ = new pbc::RepeatedField<global::EggLink.DanhengServer.Proto.OptionalReward>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<global::EggLink.DanhengServer.Proto.OptionalReward> EFMKJAJOKLK {
      get { return eFMKJAJOKLK_; }
    }
    ...
    public bool Equals(TakeAllRewardCsReq other) {
      ...
      if(!eFMKJAJOKLK_.Equals(other.eFMKJAJOKLK_)) return false;
    ...
    #else
      eFMKJAJOKLK_.WriteTo(output, _repeated_eFMKJAJOKLK_codec);
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      eFMKJAJOKLK_.WriteTo(ref output, _repeated_eFMKJAJOKLK_codec);
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      int size = 0;
      size += eFMKJAJOKLK_.CalculateSize(_repeated_eFMKJAJOKLK_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(TakeAllRewardCsReq other) {
      ...
      eFMKJAJOKLK_.Add(other.eFMKJAJOKLK_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          default:
            ...
            break;
          case 122: {
            eFMKJAJOKLK_.AddEntriesFrom(input, _repeated_eFMKJAJOKLK_codec);
            break;
          }
        }
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          default:
            ...
            break;
          case 122: {
            eFMKJAJOKLK_.AddEntriesFrom(ref input, _repeated_eFMKJAJOKLK_codec);
            break;
          }
        }
      }
