...
namespace EggLink.DanhengServer.Proto {
    ...
    static UpdateMechanismBarScNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "CghwbGFuZV9pZBgFIAEoDRImCgtBREJQUE9GR0dCQxgGIAEoCzIRLk1lY2hh",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.UpdateMechanismBarScNotify), global::EggLink.DanhengServer.Proto.UpdateMechanismBarScNotify.Parser, new[]{ "PlaneId", "ADBPPOFGGBC", "FloorId" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public UpdateMechanismBarScNotify(UpdateMechanismBarScNotify other) : this() {
      ...
      aDBPPOFGGBC_ = other.aDBPPOFGGBC_ != null ? other.aDBPPOFGGBC_.Clone() : null;
    ...
    /// <summary>Field number for the "ADBPPOFGGBC" field.</summary>
    public const int ADBPPOFGGBCFieldNumber = 6;
    private global::EggLink.DanhengServer.Proto.MechanismBarInfo aDBPPOFGGBC_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::EggLink.DanhengServer.Proto.MechanismBarInfo ADBPPOFGGBC {
      get { return aDBPPOFGGBC_; }
      set {
        aDBPPOFGGBC_ = value;
      }
    }
    ...
    public bool Equals(UpdateMechanismBarScNotify other) {
      ...
      if (!object.Equals(ADBPPOFGGBC, other.ADBPPOFGGBC)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (aDBPPOFGGBC_ != null) hash ^= ADBPPOFGGBC.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (aDBPPOFGGBC_ != null) {
        output.WriteRawTag(50);
        output.WriteMessage(ADBPPOFGGBC);
      }
      if (FloorId != 0) {
    ...
    public int CalculateSize() {
      ...
      if (aDBPPOFGGBC_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(ADBPPOFGGBC);
      }
      if (FloorId != 0) {
    ...
    public void MergeFrom(UpdateMechanismBarScNotify other) {
      ...
      if (other.aDBPPOFGGBC_ != null) {
        if (aDBPPOFGGBC_ == null) {
          ADBPPOFGGBC = new global::EggLink.DanhengServer.Proto.MechanismBarInfo();
        }
        ADBPPOFGGBC.MergeFrom(other.ADBPPOFGGBC);
      }
      if (other.FloorId != 0) {
