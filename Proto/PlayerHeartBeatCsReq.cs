...
namespace EggLink.DanhengServer.Proto {
    ...
    static PlayerHeartBeatCsReqReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ZV9tcxgBIAEoBBImCgtOTUJCQ0NHSU5KThgFIAEoCzIRLkNsaWVudFVwbG9h",
            "ZERhdGESEwoLTUdNQk9HTUROSkkYCSABKA1CHqoCG0VnZ0xpbmsuRGFuaGVu",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.PlayerHeartBeatCsReq), global::EggLink.DanhengServer.Proto.PlayerHeartBeatCsReq.Parser, new[]{ "ClientTimeMs", "NMBBCCGINJN", "MGMBOGMDNJI" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public PlayerHeartBeatCsReq(PlayerHeartBeatCsReq other) : this() {
      ...
      nMBBCCGINJN_ = other.nMBBCCGINJN_ != null ? other.nMBBCCGINJN_.Clone() : null;
    ...
    public const int NMBBCCGINJNFieldNumber = 5;
    private global::EggLink.DanhengServer.Proto.ClientUploadData nMBBCCGINJN_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::EggLink.DanhengServer.Proto.ClientUploadData NMBBCCGINJN {
    ...
    public const int MGMBOGMDNJIFieldNumber = 9;
    ...
    public bool Equals(PlayerHeartBeatCsReq other) {
      ...
      if (!object.Equals(NMBBCCGINJN, other.NMBBCCGINJN)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (nMBBCCGINJN_ != null) hash ^= NMBBCCGINJN.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (nMBBCCGINJN_ != null) {
        output.WriteRawTag(42);
        output.WriteMessage(NMBBCCGINJN);
      }
      if (MGMBOGMDNJI != 0) {
    ...
    public int CalculateSize() {
      ...
      if (nMBBCCGINJN_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(NMBBCCGINJN);
      }
      if (MGMBOGMDNJI != 0) {
    ...
    public void MergeFrom(PlayerHeartBeatCsReq other) {
      ...
      if (other.nMBBCCGINJN_ != null) {
        if (nMBBCCGINJN_ == null) {
          NMBBCCGINJN = new global::EggLink.DanhengServer.Proto.ClientUploadData();
        }
        NMBBCCGINJN.MergeFrom(other.NMBBCCGINJN);
      }
