...
namespace EggLink.DanhengServer.Proto {
    ...
    static DirectDeliveryScNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "byJNChZEaXJlY3REZWxpdmVyeVNjTm90aWZ5Eh4KC3Jld2FyZF9saXN0GAIg",
            "AygLMgkuSXRlbUxpc3QSEwoLUEtCRkJKRk9BRkEYBSABKA1CHqoCG0VnZ0xp",
            "bmsuRGFuaGVuZ1NlcnZlci5Qcm90b2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::EggLink.DanhengServer.Proto.ItemListReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.DirectDeliveryScNotify), global::EggLink.DanhengServer.Proto.DirectDeliveryScNotify.Parser, new[]{ "RewardList", "PKBFBJFOAFA" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public DirectDeliveryScNotify(DirectDeliveryScNotify other) : this() {
      ...
      pKBFBJFOAFA_ = other.pKBFBJFOAFA_;
    ...
    /// <summary>Field number for the "PKBFBJFOAFA" field.</summary>
    public const int PKBFBJFOAFAFieldNumber = 5;
    private uint pKBFBJFOAFA_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public uint PKBFBJFOAFA {
      get { return pKBFBJFOAFA_; }
      set {
        pKBFBJFOAFA_ = value;
      }
    }
    ...
    public bool Equals(DirectDeliveryScNotify other) {
      ...
      if (PKBFBJFOAFA != other.PKBFBJFOAFA) return false;
    ...
    public override int GetHashCode() {
      ...
      if (PKBFBJFOAFA != 0) hash ^= PKBFBJFOAFA.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (PKBFBJFOAFA != 0) {
        ...
        output.WriteUInt32(PKBFBJFOAFA);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (PKBFBJFOAFA != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(PKBFBJFOAFA);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(DirectDeliveryScNotify other) {
      ...
      if (other.PKBFBJFOAFA != 0) {
        PKBFBJFOAFA = other.PKBFBJFOAFA;
      }
