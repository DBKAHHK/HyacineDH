...
namespace EggLink.DanhengServer.Proto {
    ...
    static SceneEntityMoveCsReqReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "b3RvImgKFFNjZW5lRW50aXR5TW92ZUNzUmVxEhMKC0xOSU1NSkxKS0xMGAQg",
            "ASgEEikKEmVudGl0eV9tb3Rpb25fbGlzdBgLIAMoCzINLkVudGl0eU1vdGlv",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.SceneEntityMoveCsReq), global::EggLink.DanhengServer.Proto.SceneEntityMoveCsReq.Parser, new[]{ "LNIMMJLJKLL", "EntityMotionList", "EntryId" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public SceneEntityMoveCsReq(SceneEntityMoveCsReq other) : this() {
      lNIMMJLJKLL_ = other.lNIMMJLJKLL_;
    ...
    /// <summary>Field number for the "LNIMMJLJKLL" field.</summary>
    public const int LNIMMJLJKLLFieldNumber = 4;
    private ulong lNIMMJLJKLL_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public ulong LNIMMJLJKLL {
      get { return lNIMMJLJKLL_; }
      set {
        lNIMMJLJKLL_ = value;
      }
    }
    ...
    public bool Equals(SceneEntityMoveCsReq other) {
      ...
      if (LNIMMJLJKLL != other.LNIMMJLJKLL) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (LNIMMJLJKLL != 0UL) hash ^= LNIMMJLJKLL.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (LNIMMJLJKLL != 0UL) {
        ...
        output.WriteUInt64(LNIMMJLJKLL);
      }
    ...
    public int CalculateSize() {
      int size = 0;
      if (LNIMMJLJKLL != 0UL) {
        size += 1 + pb::CodedOutputStream.ComputeUInt64Size(LNIMMJLJKLL);
      }
    ...
    public void MergeFrom(SceneEntityMoveCsReq other) {
      ...
      if (other.LNIMMJLJKLL != 0UL) {
        LNIMMJLJKLL = other.LNIMMJLJKLL;
      }
