...
namespace EggLink.DanhengServer.Proto {
    ...
    static GetPlatformPlayerInfoCsReqReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "YXRmb3JtGAIgASgOMg0uUGxhdGZvcm1UeXBlEhMKC0lGSlBCQUZBT01NGAYg",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.GetPlatformPlayerInfoCsReq), global::EggLink.DanhengServer.Proto.GetPlatformPlayerInfoCsReq.Parser, new[]{ "Platform", "IFJPBAFAOMM" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public GetPlatformPlayerInfoCsReq(GetPlatformPlayerInfoCsReq other) : this() {
      ...
      iFJPBAFAOMM_ = other.iFJPBAFAOMM_.Clone();
    ...
    /// <summary>Field number for the "IFJPBAFAOMM" field.</summary>
    public const int IFJPBAFAOMMFieldNumber = 6;
    private static readonly pb::FieldCodec<string> _repeated_iFJPBAFAOMM_codec
        = pb::FieldCodec.ForString(50);
    private readonly pbc::RepeatedField<string> iFJPBAFAOMM_ = new pbc::RepeatedField<string>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<string> IFJPBAFAOMM {
      get { return iFJPBAFAOMM_; }
    }
    ...
    public bool Equals(GetPlatformPlayerInfoCsReq other) {
      ...
      if(!iFJPBAFAOMM_.Equals(other.iFJPBAFAOMM_)) return false;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      iFJPBAFAOMM_.WriteTo(output, _repeated_iFJPBAFAOMM_codec);
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      iFJPBAFAOMM_.WriteTo(ref output, _repeated_iFJPBAFAOMM_codec);
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      size += iFJPBAFAOMM_.CalculateSize(_repeated_iFJPBAFAOMM_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(GetPlatformPlayerInfoCsReq other) {
      ...
      iFJPBAFAOMM_.Add(other.iFJPBAFAOMM_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 50: {
            iFJPBAFAOMM_.AddEntriesFrom(input, _repeated_iFJPBAFAOMM_codec);
            break;
          }
        }
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          ...
          case 50: {
            iFJPBAFAOMM_.AddEntriesFrom(ref input, _repeated_iFJPBAFAOMM_codec);
            break;
          }
        }
      }
