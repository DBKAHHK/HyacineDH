...
namespace EggLink.DanhengServer.Proto {
    ...
    static RetcodeNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ZGVOb3RpZnkSGQoHcmV0Y29kZRgHIAEoDjIILlJldGNvZGUSEwoLTFBGSEhE",
            "QUpPUEQYDCADKA1CHqoCG0VnZ0xpbmsuRGFuaGVuZ1NlcnZlci5Qcm90b2IG",
            "cHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::EggLink.DanhengServer.Proto.RetcodeReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.RetcodeNotify), global::EggLink.DanhengServer.Proto.RetcodeNotify.Parser, new[]{ "Retcode", "LPFHHDAJOPD" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public RetcodeNotify(RetcodeNotify other) : this() {
      ...
      lPFHHDAJOPD_ = other.lPFHHDAJOPD_.Clone();
    ...
    /// <summary>Field number for the "LPFHHDAJOPD" field.</summary>
    public const int LPFHHDAJOPDFieldNumber = 12;
    private static readonly pb::FieldCodec<uint> _repeated_lPFHHDAJOPD_codec
        = pb::FieldCodec.ForUInt32(98);
    private readonly pbc::RepeatedField<uint> lPFHHDAJOPD_ = new pbc::RepeatedField<uint>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<uint> LPFHHDAJOPD {
      get { return lPFHHDAJOPD_; }
    }
    ...
    public bool Equals(RetcodeNotify other) {
      ...
      if(!lPFHHDAJOPD_.Equals(other.lPFHHDAJOPD_)) return false;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      lPFHHDAJOPD_.WriteTo(output, _repeated_lPFHHDAJOPD_codec);
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      lPFHHDAJOPD_.WriteTo(ref output, _repeated_lPFHHDAJOPD_codec);
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      size += lPFHHDAJOPD_.CalculateSize(_repeated_lPFHHDAJOPD_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(RetcodeNotify other) {
      ...
      lPFHHDAJOPD_.Add(other.lPFHHDAJOPD_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 98:
          case 96: {
            lPFHHDAJOPD_.AddEntriesFrom(input, _repeated_lPFHHDAJOPD_codec);
            break;
          }
        }
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          ...
          case 98:
          case 96: {
            lPFHHDAJOPD_.AddEntriesFrom(ref input, _repeated_lPFHHDAJOPD_codec);
            break;
          }
        }
      }
