...
namespace EggLink.DanhengServer.Proto {
    ...
    static GetCurBattleInfoScRspReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "RERGTkZPTEdNSEwYASABKAsyFy5BZXRoZXJEaXZpZGVCYXR0bGVJbmZvEhMK",
            "C09HQkFOQUJQQktGGAcgASgNEiUKC2JhdHRsZV9pbmZvGA0gASgLMhAuU2Nl",
            "bmVCYXR0bGVJbmZvEg8KB3JldGNvZGUYDiABKA0SKQoPbGFzdF9lbmRfc3Rh",
            "dHVzGA8gASgOMhAuQmF0dGxlRW5kU3RhdHVzQh6qAhtFZ2dMaW5rLkRhbmhl",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.GetCurBattleInfoScRsp), global::EggLink.DanhengServer.Proto.GetCurBattleInfoScRsp.Parser, new[]{ "DDFNFOLGMHL", "OGBANABPBKF", "BattleInfo", "Retcode", "LastEndStatus" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public GetCurBattleInfoScRsp(GetCurBattleInfoScRsp other) : this() {
      dDFNFOLGMHL_ = other.dDFNFOLGMHL_ != null ? other.dDFNFOLGMHL_.Clone() : null;
      oGBANABPBKF_ = other.oGBANABPBKF_;
    ...
    /// <summary>Field number for the "DDFNFOLGMHL" field.</summary>
    public const int DDFNFOLGMHLFieldNumber = 1;
    private global::EggLink.DanhengServer.Proto.AetherDivideBattleInfo dDFNFOLGMHL_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::EggLink.DanhengServer.Proto.AetherDivideBattleInfo DDFNFOLGMHL {
      get { return dDFNFOLGMHL_; }
      set {
        dDFNFOLGMHL_ = value;
      }
    }

    /// <summary>Field number for the "OGBANABPBKF" field.</summary>
    public const int OGBANABPBKFFieldNumber = 7;
    private uint oGBANABPBKF_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public uint OGBANABPBKF {
      get { return oGBANABPBKF_; }
      set {
        oGBANABPBKF_ = value;
      }
    }
    ...
    public bool Equals(GetCurBattleInfoScRsp other) {
      ...
      if (!object.Equals(DDFNFOLGMHL, other.DDFNFOLGMHL)) return false;
      if (OGBANABPBKF != other.OGBANABPBKF) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (dDFNFOLGMHL_ != null) hash ^= DDFNFOLGMHL.GetHashCode();
      if (OGBANABPBKF != 0) hash ^= OGBANABPBKF.GetHashCode();
    ...
    #else
      if (dDFNFOLGMHL_ != null) {
        output.WriteRawTag(10);
        output.WriteMessage(DDFNFOLGMHL);
      }
      if (OGBANABPBKF != 0) {
        output.WriteRawTag(56);
        output.WriteUInt32(OGBANABPBKF);
      }
      if (battleInfo_ != null) {
    ...
    public int CalculateSize() {
      int size = 0;
      if (dDFNFOLGMHL_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(DDFNFOLGMHL);
      }
      if (OGBANABPBKF != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(OGBANABPBKF);
      }
      if (battleInfo_ != null) {
    ...
    public void MergeFrom(GetCurBattleInfoScRsp other) {
      ...
      if (other.dDFNFOLGMHL_ != null) {
        if (dDFNFOLGMHL_ == null) {
          DDFNFOLGMHL = new global::EggLink.DanhengServer.Proto.AetherDivideBattleInfo();
        }
        DDFNFOLGMHL.MergeFrom(other.DDFNFOLGMHL);
      }
      if (other.OGBANABPBKF != 0) {
        OGBANABPBKF = other.OGBANABPBKF;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 10: {
            ...
            input.ReadMessage(DDFNFOLGMHL);
            break;
          }
          case 56: {
            OGBANABPBKF = input.ReadUInt32();
            break;
          }
          case 106: {
            if (battleInfo_ == null) {
