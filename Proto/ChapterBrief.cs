...
namespace EggLink.DanhengServer.Proto {
  ...
  public static partial class ChapterBriefReflection {
    ...
    static ChapterBriefReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChJDaGFwdGVyQnJpZWYucHJvdG8iXQoMQ2hhcHRlckJyaWVmEgoKAmlkGAEg",
            "ASgNEhMKC0NMQ1BCTElOQkNEGAUgASgNEhwKFHRha2VuX3Jld2FyZF9pZF9s",
            "aXN0GAkgAygNEg4KBmlzX25ldxgPIAEoCEIeqgIbRWdnTGluay5EYW5oZW5n",
            "U2VydmVyLlByb3RvYgZwcm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.ChapterBrief), global::EggLink.DanhengServer.Proto.ChapterBrief.Parser, new[]{ "Id", "CLCPBLINBCD", "TakenRewardIdList", "IsNew" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public ChapterBrief(ChapterBrief other) : this() {
      id_ = other.id_;
      cLCPBLINBCD_ = other.cLCPBLINBCD_;
    ...
    /// <summary>Field number for the "CLCPBLINBCD" field.</summary>
    public const int CLCPBLINBCDFieldNumber = 5;
    private uint cLCPBLINBCD_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public uint CLCPBLINBCD {
      get { return cLCPBLINBCD_; }
      set {
        cLCPBLINBCD_ = value;
      }
    }
    ...
    public const int TakenRewardIdListFieldNumber = 9;
    ...
    public bool Equals(ChapterBrief other) {
      ...
      if (CLCPBLINBCD != other.CLCPBLINBCD) return false;
    ...
    public override int GetHashCode() {
      ...
      if (CLCPBLINBCD != 0) hash ^= CLCPBLINBCD.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (CLCPBLINBCD != 0) {
        ...
        output.WriteUInt32(CLCPBLINBCD);
      }
    ...
    public int CalculateSize() {
      ...
      if (CLCPBLINBCD != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(CLCPBLINBCD);
      }
    ...
    public void MergeFrom(ChapterBrief other) {
      ...
      if (other.CLCPBLINBCD != 0) {
        CLCPBLINBCD = other.CLCPBLINBCD;
      }
