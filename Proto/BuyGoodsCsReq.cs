...
namespace EggLink.DanhengServer.Proto {
    ...
    static BuyGoodsCsReqReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "ZW1faWQYAiABKA0SEQoJZ29vZHNfbnVtGAQgASgNEhMKC05MTEtOQ0lOR0ZN",
            "GAYgAygNEhAKCGdvb2RzX2lkGAcgASgNEg8KB3Nob3BfaWQYCCABKA0SIQoZ",
            "aW50ZXJhY3RlZF9wcm9wX2VudGl0eV9pZBgNIAEoDUIeqgIbRWdnTGluay5E",
            "YW5oZW5nU2VydmVyLlByb3RvYgZwcm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.BuyGoodsCsReq), global::EggLink.DanhengServer.Proto.BuyGoodsCsReq.Parser, new[]{ "ItemId", "GoodsNum", "NLLKNCINGFM", "GoodsId", "ShopId", "InteractedPropEntityId" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public BuyGoodsCsReq(BuyGoodsCsReq other) : this() {
      ...
      nLLKNCINGFM_ = other.nLLKNCINGFM_.Clone();
    ...
    /// <summary>Field number for the "NLLKNCINGFM" field.</summary>
    public const int NLLKNCINGFMFieldNumber = 6;
    private static readonly pb::FieldCodec<uint> _repeated_nLLKNCINGFM_codec
        = pb::FieldCodec.ForUInt32(50);
    private readonly pbc::RepeatedField<uint> nLLKNCINGFM_ = new pbc::RepeatedField<uint>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<uint> NLLKNCINGFM {
      get { return nLLKNCINGFM_; }
    }
    ...
    public bool Equals(BuyGoodsCsReq other) {
      ...
      if(!nLLKNCINGFM_.Equals(other.nLLKNCINGFM_)) return false;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      nLLKNCINGFM_.WriteTo(output, _repeated_nLLKNCINGFM_codec);
      if (GoodsId != 0) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      nLLKNCINGFM_.WriteTo(ref output, _repeated_nLLKNCINGFM_codec);
      if (GoodsId != 0) {
        output.WriteRawTag(56);
        output.WriteUInt32(GoodsId);
      }
    ...
    public int CalculateSize() {
      ...
      size += nLLKNCINGFM_.CalculateSize(_repeated_nLLKNCINGFM_codec);
      if (GoodsId != 0) {
    ...
    public void MergeFrom(BuyGoodsCsReq other) {
      ...
      nLLKNCINGFM_.Add(other.nLLKNCINGFM_);
      if (other.GoodsId != 0) {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 50:
          case 48: {
            nLLKNCINGFM_.AddEntriesFrom(input, _repeated_nLLKNCINGFM_codec);
            break;
          }
          case 56: {
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      switch(tag) {
          ...
          case 50:
          case 48: {
            nLLKNCINGFM_.AddEntriesFrom(ref input, _repeated_nLLKNCINGFM_codec);
            break;
          }
          case 56: {
            GoodsId = input.ReadUInt32();
